...
public class RecordAdapter extends RecyclerView.Adapter<RecordAdapter.RecordViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecordViewHolder holder, int position) {
        ...
        // Set timestamp (always visible in summary section)
        ...
        holder.detailsLayout.setVisibility(isExpanded != null && isExpanded ? View.VISIBLE : View.GONE);
        holder.expandArrow.setRotation(isExpanded != null && isExpanded ? 180 : 0); // Rotate arrow: down (expanded), right (collapsed)

        holder.summaryLayout.setOnClickListener(v -> {
            record.put("isExpanded", !(isExpanded != null && isExpanded));
            notifyItemChanged(position);
        });

        // Hide the Delete button since this is the "View Records" page
